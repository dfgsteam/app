...
class AppDrawEvent { 
	...
	public JPanel buttons(JFrame frame, JPanel view, JLabel image_color, JLabel image_gray, JLabel image_pattern) {
		// Button : Original
		...
		// Button : Gray
		JButton button_gray = new JButton("Grayscala"); 
	...
	public JLabel image_color(String filename) {
		try {
	...
	public JLabel image_gray(String filename) {
		try {
			BufferedImage image_old = ImageIO.read(new File(filename));
			BufferedImage image = new BufferedImage(image_old.getWidth()*2, image_old.getHeight()*2, BufferedImage.TYPE_INT_RGB);
			for (int width=0; width<image_old.getWidth()*2; width+=2) {
	...
	public JLabel image_pattern(String filename) {
		try {
			BufferedImage image_old = ImageIO.read(new File(filename));
			BufferedImage image = new BufferedImage(image_old.getWidth()*2, image_old.getHeight()*2, BufferedImage.TYPE_INT_RGB);
	...
	public JPanel exit(JFrame frame) {
		// Button : Original
	...
	public void load_frame(JFrame frame) {
		frame.pack();
